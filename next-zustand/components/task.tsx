...
export default function Task({
  ...
  return (
    <div
      ...
      onDragStart={() => dragTask(id)} //listen to set/pass the id to on being drag
      draggable // make component dragable, mkake sure to identify what task to be dragged (store)
    >
      <div>
